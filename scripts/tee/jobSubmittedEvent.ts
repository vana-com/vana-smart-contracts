...
const teePoolAddress = "0xF084Ca24B4E29Aa843898e0B12c465fAFD089965";
...
async function jobSubmittedEvents(
  tokenAddress: string,
  startBlock: number,
  endBlock: number,
) {
  const filter = {
    ...
    toBlock: endBlock,
    topics: [
      "0xf54343d979b7d5a02524b04415a6513e2114a8284ccb9cc0e58c12a2190cb230",
    ],
  };
...
async function main() {
  let startBlock = 204874;
  let endBlock = 204876;

  console.log(await jobSubmittedEvents(teePoolAddress, startBlock, endBlock));
}
