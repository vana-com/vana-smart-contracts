    ...
    AccessControlUpgradeable
{
    ...
    modifier onlyAdmin() {
        if (!hasRole(DEFAULT_ADMIN_ROLE, msg.sender)) revert UnauthorizedAdminAction(msg.sender);
        _;
    }
    ...
    function mint(address to, uint256 amount) external whenMintIsAllowed onlyRole(MINTER_ROLE) {
