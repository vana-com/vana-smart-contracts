...
const implementationContractName = "DataPortabilityPermissionsImplementation";
const previousImplementationContractName =
  "DataPortabilityPermissionsImplementationOld";
...
export default func;
func.tags = ["DataPortabilityPermissionsImplementation"];
